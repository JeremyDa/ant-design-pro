...
export default {
  ...
  'menu.basic': '商户配置',
  'menu.basic.merchant-channel': '渠道',
  'menu.basic.merchant-paytype': '支付类型',
  'menu.basic.merchant-acc': '商户账户',
  'menu.basic.casher': '收费员',

  'menu.init': '初始数据',
  'menu.init.merchant': '商户管理',
  'menu.init.order-type': '订单类型',
  'menu.init.channel-type': '渠道类型',
  'menu.init.third': '第三方信息',
  'menu.init.pay-type': '支付类型',
  'menu.init.third-return': '第三方响应码',
  'menu.init.third-state': '第三方交易状态',
  'menu.init.trans-type': '交易类型',
  'menu.init.error-code': '错误代码',
  'menu.init.industry': '行业',
